...
public class DbInfo {
    ...
    private Boolean isSkipBadRecords;
	...
	public Boolean getIsSkipBadRecords() {
		return isSkipBadRecords;
	}
	public void setIsSkipBadRecords(Boolean isSkipBadRecords) {
		this.isSkipBadRecords = isSkipBadRecords;
	}
}
